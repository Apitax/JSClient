...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApitaxJsClient.CommandtaxApi();
  });
  ...
  describe('CommandtaxApi', function() {
    describe('command', function() {
      it('should call command successfully', function(done) {
        //uncomment below and update the code to test command
        //instance.command(function(error) {

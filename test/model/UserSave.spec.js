...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApitaxJsClient.UserSave();
  });
  ...
  describe('UserSave', function() {
    it('should create an instance of UserSave', function() {
      // uncomment below and update the code to test UserSave
      //var instane = new ApitaxJsClient.UserSave();
      //expect(instance).to.be.a(ApitaxJsClient.UserSave);
    });

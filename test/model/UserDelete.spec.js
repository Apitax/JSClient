...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApitaxJsClient.UserDelete();
  });
  ...
  describe('UserDelete', function() {
    it('should create an instance of UserDelete', function() {
      // uncomment below and update the code to test UserDelete
      //var instane = new ApitaxJsClient.UserDelete();
      //expect(instance).to.be.a(ApitaxJsClient.UserDelete);
    });
